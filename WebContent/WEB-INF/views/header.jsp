		...
		<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #44a3e8;">
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				...
				<ul class="navbar-nav ml-auto font-weight-bold">
					<div class="nav-item">
						<a class="btn btn-primary mr-2 text-light btn-sm" href="${pageContext.request.contextPath}/login" role="button">ĐĂNG NHẬP</a>
						<a class="btn btn-primary mr-2 text-light btn-sm" href="${pageContext.request.contextPath}/register" role="button">ĐĂNG KÍ</a>
					</div>
				</ul>
