...
<link rel="stylesheet" type="text/css" href="<c:url value='/resource/css/headerAdmin.css'/>">
<link rel="stylesheet"
		...
		<nav class="navbar navbar-expand-lg navbar-light" style="background-color: #44a3e8;">
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav font-weight-bold">
					...
					<li class="nav-item"><a class="nav-link text-light" href="${pageContext.request.contextPath}/administration">QUẢN LÍ</a></li>
